...
<svg width="100%" viewBox="0 0 600 280" xmlns="http://www.w3.org/2000/svg">
  <defs>
    ...
    <linearGradient id="prompt" x1="0%" y1="0%" x2="100%" y2="100%">
      <stop offset="0%" style="stop-color:#e94560;stop-opacity:1" />
      <stop offset="100%" style="stop-color:#ff6b6b;stop-opacity:1" />
    </linearGradient>
  </defs>
  <!-- 外层：Context Engineering -->
  <rect x="20" y="20" width="560" height="240" rx="16" fill="url(#outer)" />
  <text x="300" y="55" text-anchor="middle" fill="#fff" font-size="18" font-weight="bold" font-family="system-ui, sans-serif">Context Engineering</text>
  <!-- 四个组件 -->
  <rect x="50" y="80" width="230" height="50" rx="8" fill="#4a5568" />
  <text x="165" y="110" text-anchor="middle" fill="#fff" font-size="14" font-family="system-ui, sans-serif">System Prompts</text>
  <rect x="320" y="80" width="230" height="50" rx="8" fill="#4a5568" />
  <text x="435" y="110" text-anchor="middle" fill="#fff" font-size="14" font-family="system-ui, sans-serif">Knowledge Base</text>
  <rect x="50" y="145" width="230" height="50" rx="8" fill="#4a5568" />
  <text x="165" y="175" text-anchor="middle" fill="#fff" font-size="14" font-family="system-ui, sans-serif">Tools (MCP)</text>
  <rect x="320" y="145" width="230" height="50" rx="8" fill="#4a5568" />
  <text x="435" y="175" text-anchor="middle" fill="#fff" font-size="14" font-family="system-ui, sans-serif">Conversation History</text>
  <!-- 内层：Prompt Engineering -->
  <rect x="150" y="210" width="300" height="40" rx="20" fill="url(#prompt)" />
  <text x="300" y="236" text-anchor="middle" fill="#fff" font-size="14" font-weight="bold" font-family="system-ui, sans-serif">Prompt Engineering ⊂ Context</text>
</svg>
