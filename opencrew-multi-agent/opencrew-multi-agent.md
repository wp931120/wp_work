...
sequenceDiagram
    ...
    participant CoS as CoS 幕僚长
    participant CTO as CTO 技术合伙人
    participant Builder as Builder 执行者
    participant KO as KO 知识官

    User->>CoS: 在#hq 发送任务
    CoS->>CoS: 意图对齐
    CoS->>CTO: 派活到#cto
    CTO->>CTO: 拆解架构
    CTO->>Builder: 派活到#build
