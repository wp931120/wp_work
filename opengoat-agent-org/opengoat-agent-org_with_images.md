...
> 👤 **关于作者**
>
> **王鹏**，大模型算法与 AI Agent 从业者。
>
> 专注 LLM 原理、实战、应用等相关知识分享，追踪最新 LLM 和 Agent 相关资讯与知识。
>
> 相信 AI 能够改变世界。
...
![图1](opengoat-agent-org_images/diagram_1_svg.png)
...
![图2](opengoat-agent-org_images/diagram_2_mermaid.png)
