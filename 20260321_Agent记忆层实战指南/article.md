...
<svg width="100%" viewBox="0 0 700 280" xmlns="http://www.w3.org/2000/svg">
  ...
  <!-- 标题 -->
  <text x="350" y="30" text-anchor="middle" fill="#333" font-size="18" font-weight="bold" font-family="system-ui, sans-serif">Agent = Model + Harness</text>

  <!-- Model 方块 -->
  <rect x="50" y="70" width="140" height="80" rx="12" fill="url(#modelGrad)" filter="url(#shadow)"/>
  <text x="120" y="105" text-anchor="middle" fill="#fff" font-size="16" font-weight="bold" font-family="system-ui, sans-serif">Model</text>
  <text x="120" y="130" text-anchor="middle" fill="#fff" font-size="12" font-family="system-ui, sans-serif">提供智能</text>

  <!-- 加号 -->
  <text x="230" y="115" text-anchor="middle" fill="#666" font-size="24" font-weight="bold">+</text>

  <!-- Harness 大方块 -->
  <rect x="280" y="55" width="370" height="180" rx="16" fill="#fef3f5" stroke="url(#harnessGrad)" stroke-width="2" filter="url(#shadow)"/>
  <text x="465" y="85" text-anchor="middle" fill="#f5576c" font-size="16" font-weight="bold" font-family="system-ui, sans-serif">Harness（框架层）</text>

  <!-- Harness 内部组件 -->
  <rect x="300" y="100" width="100" height="50" rx="8" fill="#fff" stroke="#f5576c" stroke-width="1.5"/>
  <text x="350" y="130" text-anchor="middle" fill="#333" font-size="13" font-family="system-ui, sans-serif">Tools</text>

  <rect x="415" y="100" width="100" height="50" rx="8" fill="#fff" stroke="#f5576c" stroke-width="1.5"/>
  <text x="465" y="130" text-anchor="middle" fill="#333" font-size="13" font-family="system-ui, sans-serif">Skills</text>

  <rect x="530" y="100" width="100" height="50" rx="8" fill="#fff" stroke="#f5576c" stroke-width="1.5"/>
  <text x="580" y="130" text-anchor="middle" fill="#333" font-size="13" font-family="system-ui, sans-serif">Sandbox</text>

  <!-- Memory Layer 突出显示 -->
  <rect x="300" y="165" width="330" height="55" rx="10" fill="url(#memoryGrad)" filter="url(#shadow)"/>
  <text x="465" y="198" text-anchor="middle" fill="#fff" font-size="15" font-weight="bold" font-family="system-ui, sans-serif">🧠 Memory Layer（记忆层）</text>

  <!-- 箭头指向 Memory -->
  <path d="M120 150 L120 200 L295 200" stroke="#667eea" stroke-width="2" fill="none" marker-end="url(#arrow)"/>
  <text x="180" y="220" fill="#666" font-size="11" font-family="system-ui, sans-serif">经验沉淀</text>
</svg>
...
<svg width="100%" viewBox="0 0 700 300" xmlns="http://www.w3.org/2000/svg">
  ...
  <!-- 三个 Agent -->
  <circle cx="150" cy="80" r="45" fill="url(#agentGrad)" stroke="#667eea" stroke-width="2"/>
  <text x="150" y="85" text-anchor="middle" fill="#333" font-size="14" font-weight="bold" font-family="system-ui, sans-serif">Agent A</text>

  <circle cx="350" cy="80" r="45" fill="url(#agentGrad)" stroke="#667eea" stroke-width="2"/>
  <text x="350" y="85" text-anchor="middle" fill="#333" font-size="14" font-weight="bold" font-family="system-ui, sans-serif">Agent B</text>

  <circle cx="550" cy="80" r="45" fill="url(#agentGrad)" stroke="#667eea" stroke-width="2"/>
  <text x="550" y="85" text-anchor="middle" fill="#333" font-size="14" font-weight="bold" font-family="system-ui, sans-serif">Agent C</text>

  <!-- 输出标签 -->
  <text x="150" y="140" text-anchor="middle" fill="#666" font-size="11" font-family="system-ui, sans-serif">输出、失败、假设...</text>
  <text x="350" y="140" text-anchor="middle" fill="#666" font-size="11" font-family="system-ui, sans-serif">输出、失败、假设...</text>
  <text x="550" y="140" text-anchor="middle" fill="#666" font-size="11" font-family="system-ui, sans-serif">输出、失败、假设...</text>

  <!-- 箭头向下 -->
  <line x1="150" y1="160" x2="150" y2="200" stroke="#999" stroke-width="1.5" stroke-dasharray="5,3"/>
  <line x1="350" y1="160" x2="350" y2="200" stroke="#999" stroke-width="1.5" stroke-dasharray="5,3"/>
  <line x1="550" y1="160" x2="550" y2="200" stroke="#999" stroke-width="1.5" stroke-dasharray="5,3"/>

  <!-- Memory Layer -->
  <rect x="50" y="210" width="600" height="70" rx="12" fill="url(#memGrad)"/>
  <text x="350" y="250" text-anchor="middle" fill="#fff" font-size="16" font-weight="bold" font-family="system-ui, sans-serif">Memory Layer：过滤 → 合并 → 解决冲突 → 沉淀知识</text>

  <!-- 问题标注 -->
  <text x="100" y="260" fill="rgba(255,255,255,0.7)" font-size="10" font-family="system-ui, sans-serif">可能互相矛盾</text>
  <text x="300" y="260" fill="rgba(255,255,255,0.7)" font-size="10" font-family="system-ui, sans-serif">可能重复发现</text>
  <text x="500" y="260" fill="rgba(255,255,255,0.7)" font-size="10" font-family="system-ui, sans-serif">质量参差不齐</text>
</svg>
